 ...
 * the creation of Nunavut Territory out of the eastern portion of the formerly much larger Northwest Territories
 ...
 * the former British colony of Newfoundland joining Canada.
 ...
 * the analysis of primary sources in order to make an evidenced-based argument about the lived experiences of people
 ...
 * made no mention of Aboriginal title, or France's former Aboriginal allies
 ...
 * they effectively received no benefit or recognition.
 ...
 * was significant because it was here that France's former aboriginal allies entered into an alliance relationship (the Covenant Chain) with the British, forming the basis for future land sale treaties
 ...
 * responsible government - in which the executive council of the colony was drawn from and was answerable to the legislative assemblies of each.
 ...
 * completion of a trans-continental railway in ten years
 ...
 * That they would peacefully co-exist and respect one another's autonomy and distinct wyas.
 * none on the above

Which are federal responsibilities under section 91 of the British North America Act:

 * Indian Affairs, defense, navigaton and shipping
 ...
 * there was insufficient government relief/support for the unemployed
 * none of the above
 ...
 * the Nationalities Branch and the Indian Affairs Branch
 ...
 * the Yukon, Northwest Territories, and Nunavut. Manitoba, Ontario, Quebec and Labrador
 ...
 * refused to allow the boat to land, forcing their return to Europe
 ...
 * encourage the development of the Arctic as a habitable region to be opened for development
 ...
 * It was the first time since the Second World War that the War Measures Act was invoked, and the first time in peacetime, to deal with a domestic issue.
 ...
 * as having a distinct and separate nationality, forming a state within a state
 * none of the above
 ...
 * the transformation of Quebec in the 1960s into a modern, more secular society, one in which francophones excercised increasing control over Quebec's economy and politics.
 * none of the above
 ...
 * women
 * Scottish Canadians
 * Indigenous and African Nova Scotias
